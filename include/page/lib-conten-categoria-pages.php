                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php 
                                include 'include/lista/lista-conten-categoria-pages.php';
                             ?>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form action="procesos/guardar_categoria_pagina.php" method="POST">
                            <?php 
                                include 'include/form/lib-form-agregar-categoria-pages.php';
                             ?>
