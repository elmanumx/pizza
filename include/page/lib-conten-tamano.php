                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php 
                                include 'include/lista/lista-conten-tamano.php';
                             ?>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2 class="modal-title" id="myModalLabel">Agregar Tamaño</h2>
                        </div>
                        <div class="modal-body">
                           
                            <form action="procesos/guardar_tamano.php" method="POST">
                            <?php 
                                include 'include/form/lib-form-agregar-tamano.php';
                             ?>
                         </div>
