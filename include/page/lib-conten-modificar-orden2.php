    ...
    <div class=" col-md-12">
          ...
          <div class ="col-md-12">
            ...
            <div class="col-md-3">
                ...
                <button class="btn bg-color-red btn-lg btn-block" data-toggle="modal" data-target="#add_pizza">
            ...
            <div class="col-md-3">
                ...
                <button class="btn bg-color-red btn-lg btn-block" data-toggle="modal" data-target="#add_extra">
            ...
            <div class="col-md-3">
                ...
                <button class="btn bg-color-red btn-lg btn-block" data-toggle="modal" data-target="#add_comb">
                    <i class="icon-caret-left icon-5x"></i>
                    <i class="icon-caret-right icon-5x"></i><br>
                    <label>Pizza Combinada</label>
                </button>
            </div>
</div>
