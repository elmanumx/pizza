                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 align="center" class="modal-title" id="myModalLabel">Modificar Pagina ###</h4>
                        </div>
                        <div class="modal-body">
    <form action="procesos/modificar_pagina.php" method="POST" enctype="multipart/form-data">
                        ';
                        form_paginas($id_page);
                        echo'
             ...
             <div class="modal fade" id="baja" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <h4>Desea Eliminar la pagina ###</h4>
                        <form action="procesos/baja_pagina.php" method="POST">
                        <input type="hidden" value="'.$id_page.'" name="id_p"/>
